...
export const metadata: Metadata = {
  title: "No-Dig Drain Repairs & Pipe Relining | C4 Plus Drainage",
  description:
    "Fix damaged pipes without digging. Professional non-dig drain relining and trenchless repairs across London and Surrey. 24/7 fast response; call today!",
};
...
const liningGallery = [
  {
    src: "/images/Home/non-dig-lining/before-damaged-pipe.jpg",
    label: "Before",
    alt: "CCTV view of a damaged drain pipe with heavy scale and buildup before lining",
  },
  {
    src: "/images/Home/non-dig-lining/process-liner-prep.jpg",
    label: "Preparation",
    alt: "Resin pipe liner prepared on site ready for non-dig drain lining installation",
  },
  {
    src: "/images/Home/non-dig-lining/during-liner-install.jpg",
    label: "During",
    alt: "CCTV view during non-dig liner installation inside the existing drain pipe",
  },
  {
    src: "/images/Home/non-dig-lining/after-lined-pipe.jpg",
    label: "After",
    alt: "CCTV view of a smooth newly lined drain pipe after non-dig relining",
  },
];
  ...
  return (
    <main className="flex-1">
      <PageHero
        ...
        backgroundImage="/images/Home/non-dig-lining/after-lined-pipe.jpg"
      />
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:gap-12 lg:px-8">
          <div>
            <div className="relative mb-8 aspect-[16/9] overflow-hidden rounded-[24px] shadow-[0_20px_50px_rgba(15,28,48,0.12)] sm:mb-10">
              <Image
                src="/images/Home/non-dig-lining/during-liner-install.jpg"
                alt="CCTV view of non-dig drain lining work inside a pipe"
                fill
            ...
            <div className="mt-12">
              <h2 className="text-2xl font-bold tracking-tight text-[var(--header-top)] sm:text-3xl">
                Non Dig Technology Lining Works — Before and Afters
              </h2>
              <p className="mt-3 text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                Real CCTV footage and on-site photos from our drain lining
                projects — from damaged pipework through preparation and
                installation to a smooth, restored finish.
              </p>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                {liningGallery.map((item) => (
                  <figure
                    key={`${item.label}-${item.src}`}
                    className="overflow-hidden rounded-2xl border border-slate-200 bg-[#f8fafc] shadow-[0_8px_24px_rgba(15,28,48,0.06)]"
                  >
                    <div className="relative aspect-[4/3]">
                      <Image
                        ...
                        className="object-cover object-center"
                      />
                      <span className="absolute left-3 top-3 rounded-full bg-[var(--header-top)]/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-white">
                        {item.label}
                      </span>
                    </div>
                  </figure>
